...
usage ()
{
    echo 'Usage : ./generate_trials.sh --corpora A --enr_dur B --test_dur C'
...
python diarization_to_test_segments.py $CORPORA -d ${TEST_DUR} $OPT1

# Pairing
python pairing_enrollment_test.py --enrollments $CORPORA/enrollment_${ENR_DUR}.txt \
